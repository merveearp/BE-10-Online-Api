...
namespace EShop.API.Controllers
{
    ...
    public class ProductsController : CustomControllerBase
    {
        ...
        [HttpGet("{id}")]
        public async Task<IActionResult> GetAsync(int id, [FromQuery] bool includeCategories = false)
        {
        ...
        [HttpGet]
        public async Task<IActionResult> GetAll([FromQuery] bool 
            includeCategories = false, [FromQuery] int? categoryId = null, 
        bool isHome=false)
        {
            var response = await _productManager.GetAllAsync(
                isActive: true,
